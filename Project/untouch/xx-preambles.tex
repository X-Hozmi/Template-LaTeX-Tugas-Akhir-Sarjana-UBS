...
% \settowidth\mylen{\bfseries BAB VIII :\ } % Menyesuaikan lebar penomoran bab
...
% --- KONFIGURASI LAMPIRAN OTOMATIS ---

% 1. Mendaftarkan counter untuk total lampiran
\newcounter{totallampiran}
\regtotcounter{totallampiran}

% 2. Membuat command baru untuk Judul Lampiran Otomatis
% Penggunaan: \judulLampiran{Judul Lampiran}
\newcommand{\judulLampiran}[1]{%
	\refstepcounter{section}% Naikkan nomor section (misal A.1 ke A.2)
	\stepcounter{totallampiran}% Naikkan counter total lampiran untuk Abstrak
	\phantomsection % Agar hyperlink di PDF mengarah ke tempat yang benar
	% Menampilkan Judul di Halaman (Format: Lampiran A.1. Judul)
	\section*{Lampiran \thesection.\ #1}%
	% Menambahkan ke Daftar Isi (Format: Lampiran A.1. Judul)
	\addcontentsline{toc}{section}{\protect\numberline{}Lampiran \thesection.\ #1}%
}
...
%==================================================================
% HELPER COMMANDS UNTUK JURNAL
%==================================================================
\usepackage[T1]{fontenc}
\newcommand{\SecHead}[1]{\vspace{10pt}\noindent\textbf{#1}\par\nopagebreak\vspace{2pt}}
\newcommand{\SubHead}[1]{\noindent\textbf{#1}\par\nopagebreak}
\newcommand{\PlaceholderPar}{Text artikel ditulis disini, text artikel ditulis disini, text artikel ditulis disini, text artikel ditulis disini, text artikel ditulis disini, text artikel ditulis disini.\par}
\newcommand{\PlaceholderParShort}{Text artikel ditulis disini, text artikel ditulis disini, text artikel ditulis disini.\par}
